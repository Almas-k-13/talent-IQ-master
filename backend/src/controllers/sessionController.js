...
export async function createSession(req, res) {
  try {
    ...
    if (!userId || !clerkId) {
      console.warn("[SESSION CREATE HIT] auth missing in controller", {
    ...
    if (!["easy", "medium", "hard"].includes(normalizedDifficulty)) {
      console.warn("[SESSION CREATE HIT] invalid difficulty", { normalizedDifficulty });
    ...
    console.error("[SESSION CREATE HIT] error:", error?.stack || error);
